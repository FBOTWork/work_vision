...
from container_detector_blue_py2 import detect_and_segment_blue_container_py2

class ContainerDetectorNode:
    def __init__(self):
        rospy.init_node('container_detector_blue_node', anonymous=True)
        ...
        self.result_image_pub = rospy.Publisher("/container_detector_blue/result_image", Image, queue_size=1)
        rospy.loginfo("Publicando resultados em /container_detector_blue/result_image")

        self.centroid_2d_pub = rospy.Publisher("/container_detector_blue/centroid_2d", Point, queue_size=1)
        rospy.loginfo("Publicando centroide 2D em /container_detector_blue/centroid_2d")

        self.pose_3d_pub = rospy.Publisher("/container_detector_blue/container_pose_3d", PoseStamped, queue_size=1)
        rospy.loginfo("Publicando pose 3D em /container_detector_blue/container_pose_3d")

        # NOVO: Publicador para Marker
        self.marker_pub = rospy.Publisher("/container_detector_blue/container_marker", Marker, queue_size=1)
        rospy.loginfo("Publicando Marker 3D em /container_detector_blue/container_marker")
